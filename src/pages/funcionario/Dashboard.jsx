import { Users, CreditCard, Package, HandHeart, Star, BarChart3, LogOut } from 'lucide-react'
import { getUsuario, cerrarSesion } from '../../utils/auth'

const modulos = [
  { titulo: 'Miembros',       icono: Users,       ruta: '/funcionario/miembros'      },
  { titulo: 'Tarjetas',       icono: CreditCard,   ruta: '/funcionario/tarjetas'      },
  { titulo: 'Kits',           icono: Package,      ruta: '/funcionario/kits'          },
  { titulo: 'Donaciones',     icono: HandHeart,    ruta: '/funcionario/donaciones'    },
  { titulo: 'Patrocinadores', icono: Star,         ruta: '/funcionario/patrocinadores'},
  { titulo: 'Reportes',       icono: BarChart3,    ruta: '/funcionario/reportes'      },
]
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5]">
      ...
      <header className="bg-[#1e3a6e] text-white px-4 py-3 flex items-center justify-between shadow-md">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right hidden sm:block">
            <p className="text-xs text-blue-200">Funcionario</p>
      ...
      <div className="px-4 pt-6 pb-2">
        ...
        <p className="text-gray-500 text-sm">¿Qué deseas gestionar hoy?</p>
      </div>

      {/* Grid de módulos */}
      <main className="p-4 grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
